...
package stm32f4.periphs is
   ...
   PA0   : constant stm32f4.gpio.t_GPIO_pin  := (GPIOA, 0);

   PC6   : constant stm32f4.gpio.t_GPIO_pin  := (GPIOC, 6);
   PC7   : constant stm32f4.gpio.t_GPIO_pin  := (GPIOC, 7);

   PD12  : constant stm32f4.gpio.t_GPIO_pin  := (GPIOD, 12);
   PD13  : constant stm32f4.gpio.t_GPIO_pin  := (GPIOD, 13);
   PD14  : constant stm32f4.gpio.t_GPIO_pin  := (GPIOD, 14);
   PD15  : constant stm32f4.gpio.t_GPIO_pin  := (GPIOD, 15);
